...
- (id)init 
{
    ...
    if (self)
    {
        ...
        workflowJobs[0] = [[WorkflowJob alloc] initWithPoint:points[0] length:LENGTH width:WIDTH inputPortNum:1 outputPortNum:1 type:"Lyrical"];
        workflowJobs[1] = [[WorkflowJob alloc] initWithPoint:points[1] length:LENGTH width:WIDTH inputPortNum:1 outputPortNum:1 type:"Black & White"];
        workflowJobs[2] = [[WorkflowJob alloc] initWithPoint:points[2] length:LENGTH width:WIDTH inputPortNum:1 outputPortNum:1 type:"Cropped Border"];
